...
import { saveToken } from "../redux/slices/counterSlice";
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
        ...
        ></div>
        <div
          className="absolute top-1/2 left-1/4 w-64 h-64 bg-indigo-500/5 rounded-full blur-3xl animate-pulse"
        ...
        <div
          className="absolute bottom-40 right-32 w-2 h-2 bg-blue-300 rounded-full opacity-60 animate-ping"
          style={{ animationDelay: "1.5s" }}
        ></div>
        <div
          className="absolute top-1/2 left-40 w-1 h-1 bg-cyan-500 rounded-full opacity-60 animate-ping"
          style={{ animationDelay: "2.5s" }}
        ></div>
        <div
          className="absolute top-1/3 right-1/4 w-1 h-1 bg-indigo-400 rounded-full opacity-50 animate-ping"
          style={{ animationDelay: "3s" }}
        ></div>
        <div
          className="absolute bottom-1/4 left-1/3 w-2 h-2 bg-blue-400 rounded-full opacity-40 animate-ping"
          ...
          <div className="relative bg-gradient-to-br from-[#0a1219] via-[#0d1519] to-[#0f1b21] border border-cyan-400/40 rounded-3xl px-2 py-12 shadow-2xl shadow-cyan-400/25 overflow-hidden backdrop-blur-sm">
            ...
            <div className="relative z-10">
              ...
              <div className="mb-8 flex items-start gap-4 bg-gradient-to-r from-blue-950/40 via-indigo-950/40 to-blue-950/40 backdrop-blur-sm border border-blue-400/40 rounded-xl p-5 hover:border-blue-400/60 transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-blue-300/80 text-xs leading-relaxed">
                    Connect your wallet and sign in securely to access your
                    account.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 my-8">
                ...
                <span className="text-gray-400 text-sm font-medium bg-slate-800/50 px-4 py-2 rounded-full border border-slate-600/50">
                  OR
                </span>
