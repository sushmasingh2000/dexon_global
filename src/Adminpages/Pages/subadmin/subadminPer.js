...
// id: numeric unique ID  |  key: dot-notation string sent to the API
const PERMISSION_TREE = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 203,
        key: "members.update_password",
        label: "Update Member Password",
        icon: <FaKey />,
      },
      {
        id: 204,
        key: "members.update_max_payout",
        label: "Update Max Payout",
        icon: <FaFileInvoiceDollar />,
      },
      {
        id: 205,
        key: "members.block_unblock",
        label: "Block / Unblock Member",
        icon: <FaBan />,
      },
      {
        id: 206,
        key: "members.withdrawal_toggle",
        label: "Toggle Withdrawal Access",
        icon: <FaToggleOn />,
      },
      {
        id: 207,
        key: "members.trade_toggle",
        label: "Toggle Trade Access",
        icon: <FaToggleOn />,
      },
      {
        id: 208,
        key: "members.subadmin_grant",
        label: "Grant / Revoke SubAdmin",
        icon: <FaUserShield />,
      },
      {
        id: 209,
        key: "members.subadmin_2fa_toggle",
        label: "Toggle SubAdmin 2FA",
        icon: <FaLock />,
      },
    ],
  },
  {
    ...
    icon: <FaUniversity />,
    children: [
      { id: 301, key: "fund.topup", label: "Member Topup", icon: <FaCoins /> },
      {
        id: 302,
        key: "fund.withdrawal_approve",
        label: "Approve / Reject Withdrawal",
        icon: <FaFileInvoiceDollar />,
      },
      {
        id: 303,
        key: "fund.withdrawal_toggle",
        label: "Toggle Withdrawal Access",
        icon: <FaToggleOn />,
      },
      {
        id: 304,
        key: "fund.fund_request_approve",
      ...
      },
      {
        id: 305,
        key: "fund.set_limit",
        label: "Set Withdrawal Limit",
        icon: <FaDollarSign />,
      },
      {
        id: 306,
        key: "fund.compounding",
        label: "Manage Compounding",
        icon: <FaCoins />,
      },
    ],
  },
    ...
    children: [
      {
        id: 401,
        key: "trade.create",
        label: "Create Trade Pair",
        icon: <FaExchangeAlt />,
      },
      {
        id: 402,
        key: "trade.update_status",
        label: "Update Trade Pair Status",
        icon: <FaChartLine />,
      },
      {
        id: 403,
        key: "trade.delete",
        label: "Delete Trade Pair",
        icon: <FaTrash />,
      },
      {
        id: 404,
        key: "trade.toggle_permission",
        label: "Toggle Member Trade Access",
        icon: <FaToggleOn />,
      },
      {
        id: 405,
        key: "trade.update_profit",
        label: "Update Trade Profit",
        icon: <FaChartLine />,
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        id: 504,
        key: "reports.withdrawal",
        label: "Withdrawal Reports",
        icon: <FaMoneyBillWave />,
      },
      {
        id: 505,
        key: "reports.fund_request",
        label: "Fund Request Reports",
        icon: <FaList />,
      },
      {
        id: 506,
        key: "reports.global_activity",
  ...
  },
  {
    ...
    icon: <FaNewspaper />,
    children: [
      { id: 601, key: "news.create", label: "Create News", icon: <FaEdit /> },
      { id: 602, key: "news.update", label: "Update News", icon: <FaEdit /> },
      {
        id: 603,
        key: "news.toggle_status",
        label: "Toggle News Status",
        icon: <FaToggleOn />,
      },
    ],
  },
    ...
    children: [
      {
        id: 901,
        key: "subadmin.view",
        label: "View SubAdmins",
        icon: <FaEye />,
      },
      {
        id: 902,
        key: "subadmin.edit_permissions",
        label: "Edit SubAdmin Permissions",
        icon: <FaKey />,
      },
      {
        id: 903,
        key: "subadmin.block_unblock",
        label: "Block / Unblock SubAdmin",
        icon: <FaBan />,
      },
    ],
  },
  {
    ...
    icon: <FaHeadset />,
    children: [
      { id: 1001, key: "tickets.view", label: "View Tickets", icon: <FaEye /> },
      {
        id: 1002,
        key: "tickets.reply",
    ...
    children: [
      {
        id: 1101,
        key: "config.view",
        label: "View Master Config",
        icon: <FaEye />,
      },
      {
        id: 1102,
        key: "config.auto_payout",
        label: "Auto Payout",
        icon: <FaRobot />,
      },
      { id: 1103, key: "config.topup", label: "Topup", icon: <FaCoins /> },
      {
        id: 1104,
        key: "config.topup_bonus",
        label: "Topup Bonus (%)",
        icon: <FaCoins />,
      },
      {
      ...
      {
        id: 1106,
        key: "config.min_payin",
        label: "Minimum Pay-In ($)",
        icon: <FaDollarSign />,
      },
      {
        id: 1107,
        key: "config.fund_charges",
        label: "Fund Wallet Charges (%)",
        icon: <FaUniversity />,
      },
      {
        id: 1108,
        key: "config.earning_charges",
        label: "Earning Wallet Charges (%)",
        icon: <FaChartLine />,
      },
      {
        id: 1109,
        key: "config.capital_charges",
        label: "Capital Wallet Charges (%)",
        icon: <FaUniversity />,
      },
    ],
  },
  {
    ...
    icon: <FaQrcode />,
    children: [
      { id: 1201, key: "qr.upload", label: "Upload QR Code", icon: <FaEdit /> },
      { id: 1202, key: "qr.view", label: "View QR Codes", icon: <FaEye /> },
    ],
  },
];

// Only leaf child keys are real permissions (44 total). Parent keys are UI-only groupings.
const ALL_KEYS = PERMISSION_TREE.flatMap((p) => p.children.map((c) => c.key));
const childrenOf = (k) =>
  PERMISSION_TREE.find((p) => p.key === k)?.children.map((c) => c.key) ?? [];
...
const permsToArr = (o) =>
  Object.entries(o)
    ...
    .map(([k]) => k);
const arrToPerms = (a) =>
  Object.fromEntries(ALL_KEYS.map((k) => [k, a.includes(k)]));
...
export default function SubAdminPermissions() {
  ...
  const subAdmins =
    subAdminData?.data?.data ?? subAdminData?.data?.result ?? [];
  ...
  const handleUpdate = async () => {
    setEditSaving(true);
    const newPerms = permsToArr(editPerms);
    try {
      const token =
        localStorage.getItem("logindataen_admin") ||
        localStorage.getItem("token");
      const res = await axios.post(
        endpoint.update_subadmin_permissions,
        { login_id: editSA.login_id, permissions: newPerms },
        {
          headers: {
      ...
      if (res.status === 200) {
        ...
        queryClient.setQueryData(["get_all_subadmins"], (old) => {
          if (!old) return old;
          const list = old?.data?.data ?? old?.data?.result ?? [];
          const updated = list.map((sa) =>
            sa.login_id === editSA.login_id
              ? { ...sa, permissions: newPerms }
              : sa,
          );
  ...
  const handleBlock = async (sa) => {
    ...
    try {
      const res = await apiConnectorPostAdmin(
        endpoint?.toggle_subadmin_status,
        {
      ...
      if (String(res?.data?.success) === "true") {
        toast.success(
          status === "Yes" ? "Sub-admin blocked" : "Sub-admin unblocked",
        );
    ...
    >
        ...
        <div className="pl-5 flex items-end justify-between flex-wrap gap-3">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Sub-admins can{" "}
              <span className="text-cyan-400/70">read all data</span>.
              Permissions below control{" "}
              <span className="text-cyan-400/70">write actions</span> only.
            </p>
          </div>
          <div className="flex items-center gap-3">
            <div
              className="flex items-center gap-2 px-4 py-2 rounded-xl border border-cyan-400/15"
            ...
            <div
              className="flex items-center gap-2 px-4 py-2 rounded-xl border border-green-400/15"
        ...
        <div className="text-center py-24">
          ...
          <p className="text-gray-500 text-sm">
            {search
              ...
              : "No sub-admins found. Promote a member from the Member List page."}
          </p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
          {filtered.map((sa) => (
            <SACard
              ...
              onEdit={() => {
                setEditSA(sa);
                setEditPerms(arrToPerms(sa.permissions || []));
                setEditExpd({});
              }}
      ...
      {editSA && (
        <div
          ...
          onClick={(e) => {
            if (e.target === e.currentTarget) setEditSA(null);
          }}
        >
          <div
            className="w-full max-w-xl max-h-[92vh] flex flex-col rounded-2xl border border-cyan-400/25 overflow-hidden"
            style={{
          ...
          >
            <div
              className="flex items-center gap-4 px-6 py-4 border-b border-cyan-400/10 flex-shrink-0"
              style={{
                background:
            ...
            >
              <div
                className={`w-10 h-10 rounded-full bg-gradient-to-br ${avatarColor(editSA.lgn_name)} flex items-center justify-center font-bold text-black text-sm flex-shrink-0`}
              >
              ...
              <div
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-cyan-400/20 flex-shrink-0"
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-white/5 flex-shrink-0">
              <span className="text-xs text-gray-500">
                Toggle write-action permissions below
              </span>
              <div className="flex gap-2">
                <SMiniBtn
                  onClick={() => setEditPerms(fullPerms())}
                  color="green"
                  icon={<FaUnlock />}
                  label="Select All"
                />
                <SMiniBtn
                  onClick={() => setEditPerms(emptyPerms())}
                  color="red"
                  icon={<FaLock />}
                  label="Clear All"
                />
            ...
            <div
              className="flex items-center justify-between px-6 py-4 border-t border-cyan-400/10 flex-shrink-0"
              style={{ background: "rgba(0,0,0,0.3)" }}
            >
              <p className="text-xs text-gray-600 italic">
                Changes take effect on next sub-admin login.
              </p>
...
const SACard = ({ sa, onEdit, onBlock }) => {
  ...
  const modules = PERMISSION_TREE.filter(
    (p) =>
      permsArr.includes(p.key) ||
      p.children.some((c) => permsArr.includes(c.key)),
  );

  return (
    <div
      className="rounded-2xl border overflow-hidden transition-all duration-300 hover:-translate-y-0.5"
      style={{
        background: "linear-gradient(135deg,#080f18 0%,#0a1520 100%)",
        borderColor: blocked ? "rgba(239,68,68,0.15)" : "rgba(34,211,238,0.12)",
        boxShadow: blocked
          ? "0 4px 24px rgba(239,68,68,0.06)"
          : "0 4px 24px rgba(0,0,0,0.35)",
      }}
    >
      <div
        className={`h-0.5 ${blocked ? "bg-gradient-to-r from-red-500/60 to-transparent" : "bg-gradient-to-r from-cyan-400/50 to-transparent"}`}
      />
      <div className="p-5">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            <div
              className={`w-12 h-12 rounded-xl bg-gradient-to-br ${avatarColor(sa.lgn_name)} flex items-center justify-center font-bold text-black text-lg flex-shrink-0 shadow-lg`}
            >
          ...
          <span
            className={`text-[9px] font-bold px-2 py-1 rounded-lg border flex-shrink-0
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          ...
          {sa.lgn_created_at && (
            <div className="flex items-center gap-1.5 text-[11px] text-gray-500 col-span-2">
              ...
              <span>
                Created{" "}
                {new Date(sa.lgn_created_at).toLocaleDateString("en-IN", {
                  day: "2-digit",
                  month: "short",
                  year: "numeric",
                })}
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-2">
            ...
            >
              {totalPerms}/{ALL_KEYS.length} granted
            </span>
          </div>

          {totalPerms === 0 ? (
            <p className="text-[11px] text-gray-600 italic py-1">
              Read-only access. No write permissions.
            </p>
          ) : (
            <div className="space-y-1.5 max-h-44 overflow-y-auto custom-scroll pr-1">
              {modules.map((mod) => {
                const childGranted = mod.children.filter((c) =>
                  permsArr.includes(c.key),
                );
                const modGranted = permsArr.includes(mod.key);
                const allGranted =
                  modGranted &&
                  (mod.children.length === 0 ||
                    childGranted.length === mod.children.length);
                return (
                  <div
                    key={mod.key}
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1.5 text-[11px]">
                        <span
                          className={
                            allGranted ? "text-cyan-400" : "text-gray-500"
                          }
                        >
                          {mod.icon}
                        </span>
        ...
        <div className="flex gap-2 pt-3 border-t border-white/5">
          {hasPermission("subadmin.edit_permissions") && (
            <button
              onClick={onEdit}
            ...
            >
              <FaEdit size={11} /> Edit Permissions
            </button>
          )}
          {hasPermission("subadmin.block_unblock") && (
            <button
              onClick={onBlock}
  ...
  <div className="space-y-2">
    {tree.map((parent) => {
      ...
      return (
        ...
        >
          <div
            className="flex items-center gap-3 px-4 py-3 cursor-pointer group select-none"
            onClick={() =>
              hasK && setExpd((e) => ({ ...e, [parent.key]: !e[parent.key] }))
            }
          >
            <div
              onClick={(e) => {
            ...
            >
              ...
              {s === "partial" && (
                <div className="w-2 h-0.5 bg-yellow-400 rounded-full" />
              )}
            </div>
            <div
            ...
            <div className="flex-1">
              <span
                className={`font-semibold text-sm ${s !== "none" ? "text-white" : "text-gray-400 group-hover:text-gray-200"}`}
              >
                {parent.label}
              </span>
              {hasK && (
                <p className="text-[10px] text-gray-600 mt-0.5">
                  {parent.children.filter((c) => perms[c.key]).length}/
                  {parent.children.length} enabled
                </p>
              )}
            </div>
            <span
            ...
            >
              {s === "full" ? "FULL" : s === "partial" ? "PARTIAL" : "NONE"}
            </span>
            {hasK && (
              <span
          ...
          {hasK && open && (
            <div
              className="border-t border-white/5 px-4 py-2 space-y-1"
              ...
              {parent.children.map((child) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {on && <FaCheck size={7} className="text-black" />}
                    </div>
                    <span
                      className={`text-sm ${on ? "text-cyan-400" : "text-gray-600 group-hover:text-cyan-600"}`}
                    >
                      {child.icon}
                    </span>
                    <span
                      className={`text-sm flex-1 ${on ? "text-white font-medium" : "text-gray-500 group-hover:text-gray-300"}`}
                    >
                      {child.label}
                    </span>
                    <div
                      className={`w-7 h-4 rounded-full relative flex-shrink-0 transition-all ${on ? "bg-cyan-400" : "bg-gray-700"}`}
                    >
                      <div
                        className={`absolute top-0.5 w-3 h-3 rounded-full bg-white shadow-sm transition-all ${on ? "left-[14px]" : "left-0.5"}`}
                      />
                    </div>
                  </div>
                );
