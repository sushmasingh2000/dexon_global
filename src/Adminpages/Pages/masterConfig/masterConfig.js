            ...
            return (
              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className={`relative w-12 h-6 rounded-full transition-all duration-300 border ${
                        c.status ? "border-cyan-400/50 bg-cyan-400/20" : "border-red-400/30 bg-red-400/10"
                      }`}
                    >
                      <div className={`absolute top-0.5 w-5 h-5 rounded-full transition-all duration-300 ${
                        c.status ? "left-6 bg-cyan-400 shadow-lg shadow-cyan-400/40" : "left-0.5 bg-red-400"
                      }`} />
                    </button>
                ...
                <button
                  ...
                  className={`mt-4 w-full py-2 rounded-lg text-sm font-semibold transition-all duration-200 border relative overflow-hidden group ${
                    dirty
